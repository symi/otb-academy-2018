RSpec.describe "message passing" do
  ...
  it "raises an error if you send undefined messages" do
    ...
    expect { typical.foobar }.to raise_error( NoMethodError, /undefined method \Sfoobar\S/ )
  end

  # This test is confusing, until you work out method_missing is a private method on a parent class
